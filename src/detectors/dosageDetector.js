...
export const detectionDescriptions = {
  ...
  starts_with_plus: '+',
  aspirin_below_min: 'Asp Min-',
  aspirin_boundary_min: 'Asp Min',
  aspirin_nominal: 'Asp Nominal',
  aspirin_boundary_max: 'Asp Max',
  aspirin_above_max: 'Asp Above Max',
  ibuprofen_below_min: 'Ibu Min-',
  ibuprofen_boundary_min: 'Ibu Min',
  ibuprofen_nominal: 'Ibu Nominal',
  ibuprofen_boundary_max: 'Ibu Max',
  ibuprofen_above_max: 'Ibu Max+',
  paracetamol_below_min: 'Par Min-',
  paracetamol_boundary_min: 'Par Min',
  paracetamol_nominal: 'Par Nominal',
  paracetamol_boundary_max: 'Par Max',
  paracetamol_above_max: 'Par Max+',
  naproxen_below_min: 'Nap Min-',
  naproxen_boundary_min: 'Nap Min',
  naproxen_nominal: 'Nap Nominal',
  naproxen_boundary_max: 'Nap Max',
  naproxen_above_max: 'Nap Max+',
  ibuprofen_total_boundary_max: 'Ibu Total Max',
  ibuprofen_total_above_max: 'Ibu Total Max+',
  paracetamol_total_boundary_max: 'Par Total Max',
  paracetamol_total_above_max: 'Par Total Max+'
}
