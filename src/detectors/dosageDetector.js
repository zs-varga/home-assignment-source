...
export const detectionDescriptions = {
  ...
  comma_decimal: 'Comma Decimal',
  multiple_decimals: 'Multiple Decimals',
  ...
  aspirin_below_min: 'Aspirin Below Min',
  aspirin_boundary_min: 'Aspirin Min Boundary',
  aspirin_nominal: 'Aspirin Nominal',
  aspirin_boundary_max: 'Aspirin Max Boundary',
  aspirin_above_max: 'Aspirin Above Max',
  ibuprofen_below_min: 'Ibuprofen Below Min',
  ibuprofen_boundary_min: 'Ibuprofen Min Boundary',
  ibuprofen_nominal: 'Ibuprofen Nominal',
  ibuprofen_boundary_max: 'Ibuprofen Max Boundary',
  ibuprofen_above_max: 'Ibuprofen Above Max',
  paracetamol_below_min: 'Paracetamol Below Min',
  paracetamol_boundary_min: 'Paracetamol Min Boundary',
  paracetamol_nominal: 'Paracetamol Nominal',
  paracetamol_boundary_max: 'Paracetamol Max Boundary',
  paracetamol_above_max: 'Paracetamol Above Max',
  naproxen_below_min: 'Naproxen Below Min',
  naproxen_boundary_min: 'Naproxen Min Boundary',
  naproxen_nominal: 'Naproxen Nominal',
  naproxen_boundary_max: 'Naproxen Max Boundary',
  naproxen_above_max: 'Naproxen Above Max',
  ibuprofen_total_boundary_max: 'Ibuprofen Total Dose Boundary Max',
  ibuprofen_total_above_max: 'Ibuprofen Total Dose Above Max',
  paracetamol_total_boundary_max: 'Paracetamol Total Dose Boundary Max',
  paracetamol_total_above_max: 'Paracetamol Total Dose Above Max'
}
